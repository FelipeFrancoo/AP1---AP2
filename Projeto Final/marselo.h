...
void visualizarAlunoSD(AlunoSD alunoSD[], int numAlunosSD) {
    ...
    int indice;
    printf("Digite o �ndice do aluno que deseja visualizar (de 1 a %d): ", numAlunosSD);
    scanf("%d", &indice);
...
void editarAlunoSD(AlunoSD alunoSD[], int numAlunosSD) {
    ...
    int indice;
    printf("Digite o �ndice do aluno que deseja editar (de 1 a %d): ", numAlunosSD);
    scanf("%d", &indice);
    if (indice < 1 || indice > numAlunosSD) {
        printf("�ndice inv�lido.\n");
        return;
