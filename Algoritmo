...
void editarAluno(Aluno aluno[], int numAlunos) {
    ...
    int indice;
    printf("Digite o �ndice do aluno que deseja editar (de 1 a %d): ", numAlunos);
    scanf("%d", &indice);
    if (indice < 1 || indice > numAlunos) {
        printf("�ndice inv�lido.\n");
        return;
    }
    indice--; // Ajustar para o �ndice do vetor (come�a em 0)
  ...
  if (file == NULL) {
    ...
    }//loop para salvar os dados em suas posi��es dentro do arquivo
